\lettrine{\initial\textcolor{\initialcolor}{D}}{edúcant} óculi mei lácrimam per noc\textit{tem} \textit{et} \textbf{di}\-em,~\star \textit{et} \textit{non} \textbf{tá}\-ceant:\\
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Quare ergo \textit{per}\-\textit{cus}\textbf{sís}ti nos,~\star ita ut \textit{nul}\-\textit{la} \textit{sit} \textbf{sá}\-nitas?\par
{\numbfont\textcolor{\numbcolor}{~7.}}~Exspectávimus pacem, et \textit{non} \textit{est} \textbf{bo}\-num:~\star et tempus curatiónis, et \textit{ec}\-\textit{ce} \textit{tur}\-\textbf{bá}tio.\par
