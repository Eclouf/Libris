\lettrine{\initial\textcolor{\initialcolor}{E}}{xsultávit} cor \textit{me}\-\textit{um} \textit{in} \textbf{Dó}\-mino,~\star et exaltátum est cornu meum in \textit{De}\-\textit{o} \textbf{me}\-o.\\
...
{\numbfont\textcolor{\numbcolor}{~3.}}~Non est sanctus, ut est Dóminus:~\dagger neque enim est \textit{á}\-\textit{li}\textit{us} \textbf{ex}\-tra te,~\star et non est fortis sicut \textit{De}\-\textit{us} \textbf{nos}\-ter.\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Arcus fórti\textit{um} \textit{su}\-\textit{pe}\textbf{rá}tus est,~\star et infírmi accínc\textit{ti} \textit{sunt} \textbf{ró}\-bore.\par
...
{\numbfont\textcolor{\numbcolor}{~8.}}~Donec stérilis \textit{pé}\-\textit{pe}\textit{rit} \textbf{plú}\-rimos:~\star et quæ multos habébat fílios, \textit{in}\-\textit{fir}\textbf{má}ta est.\par
{\numbfont\textcolor{\numbcolor}{~9.}}~Dóminus mortífi\textit{cat} \textit{et} \textit{vi}\-\textbf{ví}ficat,~\star dedúcit ad ínferos \textit{et} \textit{re}\-\textbf{dú}cit.\par
...
{\numbfont\textcolor{\numbcolor}{12.}}~Ut séde\textit{at} \textit{cum} \textit{prin}\-\textbf{cí}pibus,~\star et sólium gló\-\textit{ri}\-\textit{æ} \textbf{té}\-neat.\par
