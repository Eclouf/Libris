\lettrine{\initial\textcolor{\initialcolor}{H}}{ymnum} \textit{can}\-\textit{té}\textit{mus} \textbf{Dó}\-mino,~\star hymnum novum cantémus \textit{De}\-\textit{o} \textbf{nos}\-tro.\\
...
{\numbfont\textcolor{\numbcolor}{~4.}}~Misísti spíritum tu\-\textit{um}\-, \textit{et} \textit{cre}\-\textbf{á}ta sunt,~\star et non est qui resístat \textit{vo}\-\textit{ci} \textbf{tu}\-æ.\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~\textit{Qui} \textit{au}\-\textit{tem} \textbf{ti}\-ment te,~\star magni erunt apud \textit{te} \textit{per} \textbf{óm}\-nia.\par
