\lettrine{\initial\textcolor{\initialcolor}{H}}{ymnum} can\-\textit{té}\-\textit{mus} \textbf{Dó}\-mino,~\star hymnum novum canté\textit{mus} \textit{De}\-\textit{o} \textbf{nos}\-tro.\\
...
{\numbfont\textcolor{\numbcolor}{~3.}}~Tibi sérviat omnis crea\-\textit{tú}\-\textit{ra} \textbf{tu}\-a:~\star quia di\-\textit{xís}\-\textit{ti}, \textit{et} \textbf{fac}\-ta sunt:\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Qui \textit{au}\-\textit{tem} \textbf{ti}\-ment te,~\star magni erunt a\textit{pud} \textit{te} \textit{per} \textbf{óm}\-nia.\par
