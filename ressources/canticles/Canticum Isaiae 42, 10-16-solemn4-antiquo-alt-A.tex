...
{\numbfont\textcolor{\numbcolor}{10.}}~Et ponam flú\-\textit{mi}\-\textit{na} \textit{in} \textbf{ín}\-sulas,~\star et sta\textit{gna} \textit{a}\-\textit{re}\textbf{fá}ciam.\par
{\numbfont\textcolor{\numbcolor}{11.}}~Et ducam cæcos in \textit{vi}\-\textit{am}, \textit{quam} \textbf{né}\-sciunt,~\star et in sémitis, quas ignoravérunt, ambulá\textit{re} \textit{e}\-\textit{os} \textbf{fá}\-ciam:\par
