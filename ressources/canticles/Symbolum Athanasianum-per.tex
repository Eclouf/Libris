\lettrine{\initial\textcolor{\initialcolor}{Q}}{uicúmque} \textit{vult} \textit{sal}\-\textit{vus} \textbf{es}\-se,~\star ante ómnia opus est, ut téneat Cathóli\textit{cam} \textbf{fi}\-dem:\\
