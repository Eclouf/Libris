\lettrine{\initial\textcolor{\initialcolor}{R}}{ecordáre,} Dómine, quid accí\-\textit{de}\-\textit{rit} \textbf{no}\-bis:~\star intuére et réspice op\-\textit{pró}\-\textit{bri}\textit{um} \textbf{nos}\-trum.\\
