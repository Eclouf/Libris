\lettrine{\initial\textcolor{\initialcolor}{C}}{antáte} Dómino cán\-\textit{ti}\-\textit{cum} \textbf{no}\-vum,~\star laus ejus ab \textit{ex}\-\textit{tré}\textit{mis} \textbf{ter}\-ræ:\\
...
{\numbfont\textcolor{\numbcolor}{~7.}}~Vociferábitur, \textit{et} \textit{cla}\-\textbf{má}bit:~\star super inimícos su\textit{os} \textit{con}\-\textit{for}\textbf{tá}bitur.\par
...
{\numbfont\textcolor{\numbcolor}{10.}}~Et ponam flúmi\textit{na} \textit{in} \textbf{ín}\-sulas,~\star et sta\textit{gna} \textit{a}\-\textit{re}\textbf{fá}ciam.\par
{\numbfont\textcolor{\numbcolor}{11.}}~Et ducam cæcos in vi\-\textit{am}\-, \textit{quam} \textbf{né}\-sciunt,~\star et in sémitis, quas ignoravérunt, ambulá\textit{re} \textit{e}\-\textit{os} \textbf{fá}\-ciam:\par
