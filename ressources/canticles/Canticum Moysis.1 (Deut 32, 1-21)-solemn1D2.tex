...
{\numbfont\textcolor{\numbcolor}{~4.}}~Date magnificéntiam Deo nostro.~\dagger Dei per\-\textit{féc}\-\textit{ta} \textit{sunt} \textbf{ó}\-\textbf{pe}ra,~\star et omnes viæ e\textit{jus} \textit{ju}\-\textbf{dí}\textbf{ci}a:\par
...
{\numbfont\textcolor{\numbcolor}{28.}}~Vidit Dóminus, et ad iracúndi\textit{am} \textit{con}\-\textit{ci}\textbf{tá}\textbf{tus} est:~\star quia provocavérunt eum fílii su\textit{i} \textit{et} \textbf{fí}\-\textbf{li}æ.\par
...
{\numbfont\textcolor{\numbcolor}{30.}}~Generátio \textit{e}\-\textit{nim} \textit{per}\-\textbf{vér}\textbf{sa} est,~\star et infi\-\textit{dé}\-\textit{les} \textbf{fí}\-\textbf{li}i.\par
