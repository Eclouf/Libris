\lettrine{\initial\textcolor{\initialcolor}{A}}{udíte} verbum Dó\-\textit{mi}\-\textit{ni}, \textbf{gen}\-tes,~\star et annuntiáte in ín\-\textit{su}\-\textit{lis}, \textit{quæ} \textbf{pro}\-cul sunt,\\
...
{\numbfont\textcolor{\numbcolor}{~4.}}~Et vénient, et laudábunt in \textit{mon}\-\textit{te} \textbf{Si}\-on:~\star et cónfluent \textit{ad} \textit{bo}\-\textit{na} \textbf{Dó}\-mini,\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Erítque ánima eórum quasi hor\textit{tus} \textit{ir}\-\textbf{rí}guus,~\star et ul\textit{tra} \textit{non} \textit{e}\-\textbf{sú}rient.\par
...
{\numbfont\textcolor{\numbcolor}{~9.}}~Et inebriábo ánimam sacerdó\textit{tum} \textit{pin}\-\textbf{gué}dine:~\star et pópulus meus bonis me\textit{is} \textit{ad}\-\textit{im}\textbf{plé}bitur.\par
