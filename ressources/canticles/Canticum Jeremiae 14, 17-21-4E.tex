\lettrine{\initial\textcolor{\initialcolor}{D}}{edúcant} óculi mei lácrimam per noc\textit{tem} \textit{et} \textbf{di}\-em,~\star \textit{et} \textit{non} \textbf{tá}\-\textbf{ce}ant:\\
