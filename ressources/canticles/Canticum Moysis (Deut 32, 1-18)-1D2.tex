...
{\numbfont\textcolor{\numbcolor}{~3.}}~Quasi imber super herbam, et quasi stillæ \textbf{su}\-per \textbf{grá}\-mina.~\star Quia nomen Dómini \textit{in}\-\textit{vo}\textbf{cá}bo.\par
{\numbfont\textcolor{\numbcolor}{~4.}}~Date magnificéntiam \textbf{De}\-o \textbf{nos}\-tro.~\star Dei perfécta sunt ópera, et omnes viæ e\textit{jus} \textit{ju}\-\textbf{dí}\textbf{ci}a:\par
