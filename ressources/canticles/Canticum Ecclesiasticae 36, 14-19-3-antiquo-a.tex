\lettrine{\initial\textcolor{\initialcolor}{M}}{iserére} plebi tuæ, super quam invocátum est \textbf{no}\-men \textbf{tu}\-um:~\star et Israël, quem coæquásti primo\-\textbf{gé}\-nito \textbf{tu}\-o.\\
{\numbfont\textcolor{\numbcolor}{~2.}}~Miserére civitáti sanctificatiónis \textbf{tu}\-æ, Je\-\textbf{rú}\-\textbf{sa}lem,~\star civitati requi\-\textbf{é}\-i \textbf{tu}\-æ.\par
{\numbfont\textcolor{\numbcolor}{~3.}}~Reple Sion inenarrabílibus \textbf{ver}\-bis \textbf{tu}\-is,~\star et glória tua \textbf{pó}\-pulum \textbf{tu}\-um.\par
{\numbfont\textcolor{\numbcolor}{~4.}}~Da testimónium his, qui ab inítio crea\-\textbf{tú}\-ræ \textbf{tu}\-\textbf{æ} sunt,~\star et súscita prædicatiónes, quas locúti sunt in nómine tuo pro\-\textbf{phé}\-tæ pri\-\textbf{ó}\-res.\par
