\lettrine{\initial\textcolor{\initialcolor}{E}}{t} dedísti mihi protectiónem sa\-\textit{lú}\-\textit{tis} \textbf{tu}\-æ:~\star et déxtera \textit{tu}\-\textit{a} \textit{su}\-\textbf{scé}pit me:\\
...
{\numbfont\textcolor{\numbcolor}{~4.}}~Pérsequar inimícos meos et compre\-\textit{hén}\-\textit{dam} \textbf{il}\-los:~\star et non convértar, \textit{do}\-\textit{nec} \textit{de}\-\textbf{fí}ciant.\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Et præcinxísti me virtú\textit{te} \textit{ad} \textbf{bel}\-lum:~\star et supplantásti insurgén\textit{tes} \textit{in} \textit{me} \textbf{sub}\-tus me.\par
...
{\numbfont\textcolor{\numbcolor}{10.}}~Erípies me de contradictió\-\textit{ni}\-\textit{bus} \textbf{pó}\-puli:~\star constítues me \textit{in} \textit{ca}\-\textit{put} \textbf{gén}\-tium.\par
...
{\numbfont\textcolor{\numbcolor}{17.}}~Magníficans salútes Regis ejus,~\dagger et fáciens misericórdiam Christo \textit{su}\-\textit{o} \textbf{Da}\-vid:~\star et sémini ejus \textit{us}\-\textit{que} \textit{in} \textbf{sǽ}\-culum.\par
