\lettrine{\initial\textcolor{\initialcolor}{M}}{iserátor,} et misé\-\textit{ri}\-\textit{cors} \textbf{Dó}\-minus:~\star pátiens, et \textit{mul}\-\textit{tum} \textit{mi}\-\textbf{sé}\textbf{ri}cors.\\
