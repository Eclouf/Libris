...
{\numbfont\textcolor{\numbcolor}{~4.}}~Inhabitábo in tabernáculo \textbf{tu}\-o in \textbf{sǽ}\-\textbf{cu}la:~\star prótegar in velaménto a\-\textbf{lá}\-rum tu\-\textbf{á}\-rum.\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Dies super dies \textbf{re}\-gis ad\-\textbf{jí}\-\textbf{ci}es:~\star annos ejus usque in diem generatiónis et gene\-\textbf{ra}\-ti\-\textbf{ó}\-nis.\par
...
{\numbfont\textcolor{\numbcolor}{~8.}}~Sic psalmum dicam nómini tuo in \textbf{sǽ}\-culum \textbf{sǽ}\-\textbf{cu}li:~\star ut reddam vota mea de \textbf{di}\-e in \textbf{di}\-em.\par
