...
{\numbfont\textcolor{\numbcolor}{~4.}}~Qui dixérunt: Linguam nostram magnificábimus,~\dagger lábia \textbf{nos}\-tra a \textbf{no}\-\textbf{bis} sunt,~\star quis noster \textit{Dó}\-\textit{mi}\textbf{nus} est?\par
{\numbfont\textcolor{\numbcolor}{~5.}}~Propter misériam ínopum, et \textbf{gé}\-mitum \textbf{páu}\-\textbf{pe}rum,~\star nunc exsúrgam, \textit{di}\-\textit{cit} \textbf{Dó}\-minus.\par
...
{\numbfont\textcolor{\numbcolor}{~9.}}~In circúitu \textbf{ím}\-pii \textbf{ám}\-\textbf{bu}lant:~\star secúndum altitúdinem tuam multiplicásti fí\-\textit{li}\-\textit{os} \textbf{hó}\-minum.\par
