...
{\numbfont\textcolor{\numbcolor}{~3.}}~Quoúsque irrúi\textbf{tis} in \textbf{hó}\-\textbf{mi}nem?~\star interfícitis univérsi vos: tamquam paríeti inclináto et macéri\textit{æ} \textit{de}\-\textbf{púl}sæ?\par
...
{\numbfont\textcolor{\numbcolor}{10.}}~Nolíte speráre in iniquitáte, et rapínas nolíte \textbf{con}\-cu\-\textbf{pí}\-\textbf{sce}re:~\star divítiæ si áffluant, nolíte \textit{cor} \textit{ap}\-\textbf{pó}nere.\par
{\numbfont\textcolor{\numbcolor}{11.}}~Semel locútus est Deus, duo hæc audívi, quia potéstas Dei est, et tibi, Dómine, mi\-\textbf{se}\-ri\-\textbf{cór}\-\textbf{di}a:~\star quia tu reddes unicuíque juxta ó\-\textit{pe}\-\textit{ra} \textbf{su}\-a.\par
