\lettrine{\initial\textcolor{\initialcolor}{D}}{eus} stetit in synagó\textit{ga} \textit{de}\-\textbf{ó}rum:~\star in médio autem \textit{de}\-\textit{os} \textit{di}\-\textbf{jú}dicat.\\
