\lettrine{\initial\textcolor{\initialcolor}{C}}{ircumdedérunt} me ví\-\textit{tu}\-\textit{li} \textbf{mul}\-ti:~\star tauri pin\textit{gues} \textit{ob}\-\textit{se}\textbf{dé}\textbf{runt} me.\\
