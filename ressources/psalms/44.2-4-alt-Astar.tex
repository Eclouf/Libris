...
{\numbfont\textcolor{\numbcolor}{~4.}}~Omnis glória ejus fíliæ Re\textit{gis} \textit{ab} \textbf{in}\-tus,~\star in fímbriis áureis circumamícta \textit{va}\-\textit{ri}\textit{e}\textbf{tá}tibus.\par
...
{\numbfont\textcolor{\numbcolor}{~9.}}~Proptérea pópuli confitebúntur tibi \textit{in} \textit{æ}\-\textbf{tér}num:~\star et in \textit{sǽ}\-\textit{cu}\textit{lum} \textbf{sǽ}\-culi.\par
