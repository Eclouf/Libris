\lettrine{\initial\textcolor{\initialcolor}{C}}{rédidi,} propter quod \textit{lo}\-\textbf{cú}tus sum:~\star ego autem humiliá\textit{tus} \textit{sum} \textbf{ni}\-mis.\\
...
{\numbfont\textcolor{\numbcolor}{~9.}}~Laudáte Dóminum, om\textit{nes} \textbf{Gen}\-tes:~\star laudáte eum, \textit{om}\-\textit{nes} \textbf{pó}\-puli:\par
{\numbfont\textcolor{\numbcolor}{10.}}~Quóniam confirmáta est super nos misericórdi\textit{a} \textbf{e}\-jus:~\star et véritas Dómini manet \textit{in} \textit{æ}\-\textbf{tér}num.\par
