\lettrine{\initial\textcolor{\initialcolor}{T}}{e} decet hymnus, De\-\textit{us}\-, \textit{in} \textbf{Si}\-on:~\star et tibi reddétur vo\textit{tum} \textit{in} \textit{Je}\-\textbf{rú}salem.\\
