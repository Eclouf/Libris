\lettrine{\initial\textcolor{\initialcolor}{L}}{íbera} me quia egénus, et \textbf{pau}\-per \textbf{e}\-go sum:~\star et cor meum contur\-\textbf{bá}\-tum est \textbf{in}\-tra me.\\
{\numbfont\textcolor{\numbcolor}{~2.}}~Sicut umbra cum de\-\textbf{clí}\-nat, ab\-\textbf{lá}\-tus sum:~\star et excússus sum \textbf{sic}\-ut lo\-\textbf{cús}\-tæ.\par
{\numbfont\textcolor{\numbcolor}{~3.}}~Génua mea infirmáta sunt \textbf{a} je\-\textbf{jú}\-nio:~\star et caro mea immutáta est \textbf{prop}\-ter \textbf{ó}\-leum.\par
...
{\numbfont\textcolor{\numbcolor}{~6.}}~Et sciant quia \textbf{ma}\-nus \textbf{tu}\-a hæc:~\star et tu, Dómine, fe\-\textbf{cís}\-ti \textbf{e}\-am.\par
...
{\numbfont\textcolor{\numbcolor}{10.}}~Quia ástitit a \textbf{dex}\-tris \textbf{páu}\-peris,~\star ut salvam fáceret a persequéntibus \textbf{á}\-nimam \textbf{me}\-am.\par
